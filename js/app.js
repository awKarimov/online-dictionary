...
const nounBlock = document.getElementById("noun-block");
...
function nounMeanings(meaning) {
  nounBlock.classList.remove("hidden");
  nounDefs.innerHTML = "";
...
function verbMeanings(meaning) {
  verbBlock.classList.remove("hidden");
  verbDefs.innerHTML = "";
...
function reset() {
  nounBlock.classList.add("hidden");
  verbBlock.classList.add("hidden");
